...
# Some limits might be raised
SENTRY_MAX_DICTIONARY_ITEMS = env('SENTRY_MAX_DICTIONARY_ITEMS', 50)
SENTRY_MAX_EXCEPTIONS = env('SENTRY_MAX_EXCEPTIONS', 25)
SENTRY_MAX_EXTRA_VARIABLE_SIZE = env('SENTRY_MAX_EXTRA_VARIABLE_SIZE', 16384)
SENTRY_MAX_HTTP_BODY_SIZE = env('SENTRY_MAX_HTTP_BODY_SIZE', 16384)
SENTRY_MAX_MESSAGE_LENGTH = env('SENTRY_MAX_MESSAGE_LENGTH', 8192)
SENTRY_MAX_STACKTRACE_FRAMES = env('SENTRY_MAX_STACKTRACE_FRAMES', 50)
SENTRY_MAX_VARIABLE_SIZE = env('SENTRY_MAX_VARIABLE_SIZE', 512)
